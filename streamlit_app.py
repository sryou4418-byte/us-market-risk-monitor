...
.r38-hero-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:11px}.r38-hero-card{position:relative;min-height:300px;border:1px solid #e3e7ed;border-radius:11px;padding:19px 19px 17px;box-sizing:border-box;background:#fff;overflow:visible}.r38-hero-card.danger{border-color:#f0dddd}.r38-hero-card.warn{border-color:#f0e4cf}.r38-card-title{font-size:16.5px;font-weight:800;color:#3a4049;display:flex;align-items:center;gap:6px}.r38-horizon{font-size:12.5px;color:#8b929d;margin-top:4px}.r38-hero-main{display:grid;grid-template-columns:minmax(0,1fr) minmax(118px,34%);align-items:center;gap:18px;margin-top:18px;min-height:120px}.r38-hero-left{min-width:0}.r38-hero-side{min-width:0;display:flex;align-items:center;justify-content:flex-end;text-align:left}.r38-big{font-size:45px;font-weight:850;line-height:1;white-space:nowrap;letter-spacing:-.05em}.r38-big.red{color:#d92f3b}.r38-big.orange{color:#d77b00}.r38-unit{font-size:14px;font-weight:650;white-space:nowrap;color:#555d68;margin-left:4px}.r38-badge{display:inline-flex;border-radius:999px;padding:6px 10px;font-size:12px;font-weight:800;margin-top:9px}.r38-badge.red{color:#fff;background:#e83d49}.r38-badge.orange{color:#fff;background:#f09a18}.r38-badge.green{color:#fff;background:#2ca675}.r38-badge.gray{color:#5e6672;background:#eef1f5}.r38-delta-label{font-size:12px;color:#737b87}.r38-delta{font-size:14px;margin-top:4px;font-weight:800}.r38-up{color:#e03b45}.r38-down{color:#2f70c9}.r38-flat{color:#7b8490}.r38-side-copy{font-size:13px;line-height:1.45;color:#616a76;font-weight:700;max-width:145px}.r38-side-copy strong{display:block;font-size:14px;color:#343b45;margin-bottom:3px}.r38-signal-main{font-size:38px;font-weight:850;white-space:nowrap;line-height:1.05;letter-spacing:-.035em;color:#252b34}.r38-signal-meta{font-size:13px;color:#707985;margin-top:8px;font-weight:700}.r38-callout{position:absolute;left:12px;right:12px;bottom:12px;min-height:58px;box-sizing:border-box;border-radius:8px;padding:12px 13px;font-size:12.5px;line-height:1.5;background:#fff6f6;border:1px solid #f5dede;color:#5c3b3e;display:flex;flex-direction:column;justify-content:center}.r38-callout.warn{background:#fff9ef;border-color:#f3e4c9;color:#69523a}.r38-summary-lines{display:flex;flex-direction:column;gap:3px}.r38-summary-lines b{font-weight:820}.r38-chips{display:flex;flex-wrap:wrap;gap:5px;margin-top:7px}.r38-chip{display:inline-flex;padding:4px 8px;border-radius:999px;background:#fff0f0;border:1px solid #f3d3d3;color:#c33b42;font-size:11.5px;font-weight:750}.r38-chip.warn{background:#fff5e7;border-color:#f0ddbd;color:#a76600}.r38-interpret{margin-top:12px;padding:12px 14px;border-radius:8px;background:#f8fafc;border:1px solid #e7ebf0;font-size:13px;line-height:1.55;color:#555e69}
...
@media(max-width:1180px) and (min-width:781px){.r38-hero-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.r38-hero-card:first-child{grid-column:1/-1}.r38-hero-card{min-height:292px}.r38-hero-main{grid-template-columns:minmax(0,1fr) minmax(130px,34%)}.r38-big{white-space:nowrap}.r38-unit{white-space:nowrap}.r38-signal-main{white-space:nowrap}}
