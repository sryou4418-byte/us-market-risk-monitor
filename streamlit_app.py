...
# v3.38.4 full dashboard redesign — Streamlit engine + custom HTML/CSS skin.
st.markdown("""<style>
...
.r38-mobilebar{display:none}.r38-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:16px}.r38-title{font-size:30px;font-weight:850;letter-spacing:-.045em;line-height:1.18}.r38-subtitle{font-size:15px;color:#69717d;margin-top:6px}.r38-credit{font-size:12px;color:#939aa5;margin-top:3px}.r38-head-actions{display:flex;gap:10px}.r38-action{height:44px;border:1px solid #dfe4eb;border-radius:8px;background:#fff;padding:0 15px;display:flex;align-items:center;font-size:14px;font-weight:650;color:#3c4654}
...
.r38-hero-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:11px;align-items:stretch}.r38-hero-card{position:relative;min-height:304px;height:100%;border:1px solid #e3e7ed;border-radius:11px;padding:19px 19px 17px;box-sizing:border-box;background:#fff;overflow:visible;display:flex;flex-direction:column}.r38-hero-card.danger{border-color:#f0dddd}.r38-hero-card.warn{border-color:#f0e4cf}.r38-card-title{font-size:16.5px;font-weight:800;color:#3a4049;display:flex;align-items:center;gap:6px}.r38-horizon{font-size:12.5px;color:#8b929d;margin-top:4px}.r38-hero-main{display:grid;grid-template-columns:minmax(0,1fr) 150px;align-items:center;gap:14px;margin-top:16px;min-height:124px;flex:1}.r38-big{font-size:45px;font-weight:850;line-height:1;white-space:nowrap;letter-spacing:-.05em}.r38-big.red{color:#d92f3b}.r38-big.orange{color:#d77b00}.r38-unit{font-size:14px;font-weight:650;white-space:nowrap;color:#555d68;margin-left:4px}.r38-badge{display:inline-flex;border-radius:999px;padding:6px 10px;font-size:12px;font-weight:800;margin-top:9px}.r38-badge.red{color:#fff;background:#e83d49}.r38-badge.orange{color:#fff;background:#f09a18}.r38-badge.green{color:#fff;background:#2ca675}.r38-badge.gray{color:#5e6672;background:#eef1f5}.r38-delta-label{font-size:12px;color:#737b87;margin-top:13px}.r38-delta{font-size:13.5px;margin-top:4px;font-weight:750}.r38-up{color:#e03b45}.r38-down{color:#2f70c9}.r38-flat{color:#7b8490}.r38-gauge-wrap{width:150px;justify-self:end;align-self:center}.r38-gauge-delta{text-align:center;margin-bottom:3px}.r38-gauge-delta .r38-delta-label{margin-top:0}.r38-gauge-delta .r38-delta{margin-top:2px}.r38-gauge{width:150px;height:92px;justify-self:end}.r38-gauge svg{width:100%;height:100%}.r38-gauge-label{font-size:8px;fill:#8b929d}.r38-floor-box{width:142px;min-height:92px;justify-self:end;border:1px solid #e5e9ef;border-radius:12px;background:#fafbfc;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:10px;box-sizing:border-box}.r38-floor-label{font-size:10.5px;color:#7a838f;font-weight:700}.r38-floor-value{font-size:28px;font-weight:850;line-height:1.1;margin-top:5px;color:#343a43}.r38-floor-value.orange{color:#d77b00}.r38-floor-value.red{color:#d92f3b}.r38-hero-main.signal-only{display:grid;grid-template-columns:minmax(0,1fr) minmax(150px,.82fr);align-items:center;gap:18px;min-height:124px;padding-top:4px;flex:1}.r38-signal-side{font-size:12.5px;line-height:1.55;color:#586474;font-weight:650;padding-left:4px}.r38-signal-side b{display:block;color:#263240;font-size:12px;margin-bottom:4px}.r38-signal-main{font-size:38px;font-weight:850;white-space:nowrap;line-height:1.05;letter-spacing:-.035em;color:#252b34}.r38-signal-meta{font-size:13px;color:#707985;margin-top:8px;font-weight:700}.r38-callout{position:static;margin-top:12px;min-height:58px;border-radius:8px;padding:11px 13px;font-size:12.5px;line-height:1.5;background:#fff6f6;border:1px solid #f5dede;color:#5c3b3e;box-sizing:border-box;display:flex;flex-direction:column;justify-content:center}.r38-callout.warn{background:#fff9ef;border-color:#f3e4c9;color:#69523a}.r38-chips{display:flex;flex-wrap:wrap;gap:5px;margin-top:7px}.r38-chip{display:inline-flex;padding:4px 8px;border-radius:999px;background:#fff0f0;border:1px solid #f3d3d3;color:#c33b42;font-size:11.5px;font-weight:750}.r38-chip.warn{background:#fff5e7;border-color:#f0ddbd;color:#a76600}.r38-interpret{margin-top:12px;padding:13px 15px;border-radius:9px;background:#eef7ff;border:1px solid #d6e9f9;font-size:13.5px;line-height:1.55;color:#27445f;font-weight:600}.r38-interpret-label{font-weight:850;color:#1f5f91;margin-right:8px;white-space:nowrap}
.r38-risk-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:9px}.r38-risk-card{border:1px solid #e2e7ed;border-radius:9px;padding:15px 12px 13px;min-height:158px}.r38-risk-top{display:flex;align-items:center;gap:8px}.r38-risk-icon{width:28px;height:28px;border-radius:7px;background:#f2f6ff;border:1px solid #dfe7fa;display:flex;align-items:center;justify-content:center;color:#345ec8;font-size:14px;font-weight:800}.r38-risk-name{font-size:clamp(11.5px,.78vw,13px);font-weight:760;color:#3d4550;display:flex;align-items:center;gap:5px;white-space:nowrap;min-width:0}.r38-risk-numrow{display:flex;align-items:center;justify-content:space-between;margin-top:15px}.r38-risk-score{font-size:clamp(23px,1.7vw,28px);font-weight:850;white-space:nowrap}.r38-mini-state{font-size:clamp(9px,.66vw,11px);font-weight:800;border-radius:999px;padding:4px 7px;background:#fff1f1;color:#d63e46;white-space:nowrap}.r38-mini-state.mid{background:#fff7df;color:#c98300}.r38-mini-state.low{background:#edf8f3;color:#24855e}.r38-segments{display:flex;gap:3px;margin-top:13px}.r38-seg{height:4px;flex:1;border-radius:99px;background:#e8ebef}.r38-seg.on-red{background:#ea3944}.r38-seg.on-orange{background:#f0a018}.r38-seg.on-green{background:#3da77a}.r38-risk-foot,.r38-note{font-size:11.5px;color:#8c949f;margin-top:10px}
...
@media(max-width:1280px) and (min-width:781px){.r38-hero-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.r38-hero-card:first-child{grid-column:1/-1}.r38-hero-card{min-height:286px}.r38-big{white-space:nowrap}.r38-unit{white-space:nowrap}.r38-signal-main{white-space:nowrap}}
...
@media (orientation:portrait) and (min-width:781px){
  .r38-hero-grid{grid-template-columns:1fr!important}
  .r38-hero-card:first-child{grid-column:auto!important}
  .r38-hero-card{min-height:286px}
  .r38-hero-main.signal-only{grid-template-columns:minmax(0,1fr) minmax(220px,.9fr)}
  ...
  .r38-risk-name{font-size:clamp(9.5px,1.18vw,12px)}
  .r38-mini-state{font-size:clamp(8px,.95vw,10px);padding:3px 5px}
  .r38-risk-score{font-size:clamp(21px,2.55vw,26px)}
  .r38-risk-foot{font-size:clamp(8px,.95vw,10.5px);white-space:nowrap}
...
st.markdown(f'''<div class="r38-head"><div><div class="r38-title">미국 증시 위험 모니터</div><div class="r38-subtitle">현재 시장 상황과 주요 위험 신호를 한눈에 확인하세요.</div><div class="r38-credit">Developed by 유유상 · v3.38.4</div></div><div class="r38-head-actions"><div class="r38-action">{now_kst.strftime('%Y.%m.%d')}　▣</div><div class="r38-action">↻　데이터 업데이트</div></div></div>''',unsafe_allow_html=True)
refresh_indicator()
...
<div class="r38-hero-card danger"><div class="r38-card-title">위험지수 {_info38("시장·밸류에이션, 변동성, 금리, 신용, 경기, 물가를 가중 합산한 기본 위험도에 구조·급변·진행 중 시장 스트레스 하한을 적용한 최종 위험지수입니다.")}</div><div class="r38-horizon">중기 · 누적 시장 취약성</div><div class="r38-hero-main"><div><div><span class="r38-big {'red' if overall>=61 else ('orange' if overall>=41 else '')}">{overall:.1f}</span><span class="r38-unit">/ 100</span></div>{_risk_badge(overall)}</div><div class="r38-gauge-wrap"><div class="r38-gauge-delta"><div class="r38-delta-label">전일 대비</div><div class="r38-delta r38-{delta_class}">{_esc(delta_text)}</div></div>{_gauge_svg(overall,hero_tone)}</div></div><div class="r38-callout"><div>현재 위험도 <b>{_esc(label(overall))}</b></div><div>구조적 신호 <b>{_structure_count}개</b> · 급변 신호 <b>{_rapid_count}개</b></div></div></div>
<div class="r38-hero-card warn"><div class="r38-card-title">구조적 위험 {_info38("장단기금리 역전 기억, 높은 CAPE, 물가 재가속, 고용 악화처럼 수개월 이상 지속될 수 있는 구조적 취약성을 감지합니다.")}</div><div class="r38-horizon">수개월~1년 · 지속 취약성</div><div class="r38-hero-main signal-only"><div><div class="r38-signal-main">{_esc(struct_label)}</div><span class="r38-badge {'orange' if _structure_count else 'green'}">신호 {_structure_count}개</span></div><div class="r38-signal-side"><b>{'활성 구조 신호' if _structure_count else '구조 신호'}</b>{'현재 구조적 취약성이 감지되었습니다.' if _structure_count else '현재 뚜렷한 구조적 취약성은 없습니다.'}</div></div><div class="r38-callout warn"><b>감지된 신호 ({_structure_count}개)</b><div class="r38-chips">{struct_chips}</div></div></div>
<div class="r38-hero-card danger"><div class="r38-card-title">시장 급변 신호 {_info38("VIX, 신용 스프레드, 10년물 금리 상승, 신규 실업수당 추세 등 서로 다른 빠른 지표가 동시에 악화되는지를 봅니다. 1개 축은 관찰만 하며, 2개 이상 동시 확인되면 단기 시장 스트레스가 강화된 것으로 해석합니다.")}</div><div class="r38-horizon">수일~수주 · 단기 시장 스트레스</div><div class="r38-hero-main signal-only"><div><div class="r38-signal-main">{_esc(rapid_label)}</div><span class="r38-badge {'red' if _rapid_count>=2 else ('orange' if _rapid_count else 'green')}">급변 {_rapid_count}개</span></div><div class="r38-signal-side"><b>{'단기 스트레스' if _rapid_count else '급변 신호'}</b>{'여러 단기 위험 축이 동시에 악화되고 있습니다.' if _rapid_count>=2 else ('단일 위험 축을 관찰 중입니다.' if _rapid_count else '현재 뚜렷한 단기 급변 신호는 없습니다.')}</div></div><div class="r38-callout"><b>감지된 신호 ({_rapid_count}개)</b><div class="r38-chips">{rapid_chips}</div></div></div>
...
label_map={'시장·밸류에이션':'시장 과열도','변동성':'변동성','금리':'금리','신용':'신용 시장','경기':'경기','물가':'물가'}; icon_map={'시장·밸류에이션':'▧','변동성':'↕','금리':'%','신용':'▤','경기':'▥','물가':'◉'}
risk_info_map={
